// 内置分组规则数据：纯数据文件，新增内置分组只需在此追加条目。
import type { GroupRule } from "../types.ts";

export const DEFAULT_ICON = "https://registry.npmmirror.com/@lobehub/icons-static-webp/latest/files/light/openai.webp";
